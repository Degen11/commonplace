...
import { useFloating, useInteractions, useDismiss, offset, flip, shift, autoUpdate, FloatingPortal } from "@floating-ui/react";
...
// ── Inline category picker with @floating-ui positioning ──
export function InlineCategorySelect({ current, allCats, onSave, onCancel, customCats, anchorEl }) {
  ...
  const { refs, floatingStyles, context } = useFloating({
    ...
    open: true,
    onOpenChange: (open) => { if (!open) onCancelRef.current(); },
  ...
  return (
    <FloatingPortal>
      <div ref={refs.setFloating} onClick={e => e.stopPropagation()} style={{
        ...floatingStyles,
        zIndex: 100,
