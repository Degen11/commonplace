...
function CollectionRow({
  ...
  return (
      ...
      style={{
        ...
        ...(dragOver
          ? {
              ...
              outline: "2px solid var(--cp-drag-insert)",
              outlineOffset: -2,
              animation: "dropGlow .8s ease infinite",
            }
          : {}),
      }}
    ...
    >
      <Popover.Root
        open={iconPickerId === c.id}
        onOpenChange={(open) => {
          if (!open) setIconPickerId(null);
        }}
      >
        <Popover.Trigger
          render={<span />}
          ...
          onClick={(e) => {
            e.stopPropagation();
            setIconPickerId((prev) => (prev === c.id ? null : c.id));
          }}
        >
          {createElement(icon, {
            size: 14,
      ...
      <span
        style={{
          flex: 1,
          fontSize: 13,
          color: isActive ? "var(--cp-accent)" : "var(--cp-text-secondary)",
  ...
  useEffect(() => {
    const handler = (e) => {
      ...
      if (
        isSmartGrouping &&
        !smartGroupLoading &&
        smartWrapRef.current &&
        !smartWrapRef.current.contains(e.target)
      ) {
    ...
    >
      ...
      <div style={styles.sidebarOverview}>
        ...
        <div style={styles.sidebarOverviewRow}>
          <span
            style={{
              ...styles.sidebarOverviewMuted,
              display: "flex",
              alignItems: "center",
              gap: 6,
            }}
          >
            <Library size={13} strokeWidth={1.5} /> Entries
          </span>
          <span style={styles.sidebarOverviewValue}>
            <AnimatedNumber value={totalQuotes} />
          </span>
        </div>
        <div style={styles.sidebarOverviewRow}>
          ...
          >
            <Globe size={13} strokeWidth={1.5} /> Sources
          </span>
          <span style={styles.sidebarOverviewValue}>
            <AnimatedNumber value={uniqueSources || 0} />
          </span>
        </div>
        {favCount > 0 && (
          <div style={styles.sidebarOverviewRow}>
            ...
            >
              <Star size={13} strokeWidth={1.5} /> Favorites
            </span>
            <span style={{ ...styles.sidebarOverviewValue, color: CLR_AMBER }}>
        ...
        {onFindDupes && (
          <div style={{ marginTop: 6 }}>
            <button
              className="sidebar-dupes-btn"
              style={styles.sidebarDupesBtn}
              onClick={onFindDupes}
            >
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 3 }}>
            <div
              style={{
                ...
                gap: 0,
                alignItems: "center",
                border: `1px solid ${createError ? CLR_RED : "var(--cp-accent)"}`,
                borderRadius: 6,
                background: "var(--cp-bg-card)",
                overflow: "hidden",
              }}
        ...
        <div ref={smartWrapRef} style={{ padding: "0 0 6px 0" }}>
          {isSmartGrouping ? (
            <div style={{ display: "flex", flexDirection: "column", gap: 3 }}>
              ...
              >
                ...
                <button
                  ...
                  style={{
                    ...
                    border: "none",
                    color:
                      smartGroupLoading || !smartTheme.trim()
                        ? "var(--cp-text-faint)"
                        : "var(--cp-accent)",
                    padding: "5px 8px",
              ...
              {smartGroupError && (
                <span style={{ fontSize: 11, color: CLR_RED, paddingLeft: 2 }}>
                  {smartGroupError}
                </span>
              )}
            </div>
