...
function DupeModalInner({ pendingDupes, dupeDecisions, setDupeDecision, onContinue }) {
  const keptCount = Object.values(dupeDecisions).filter(
    (d) => d === "keep" || d === "merge",
  ).length;
    ...
    >
      <div style={styles.dupeModalHeader}>
        ...
        <Dialog.Description style={styles.dupeModalSub}>
          We found {pendingDupes.length} {pendingDupes.length === 1 ? "entry" : "entries"} similar
          to ones already in your collection.
        </Dialog.Description>
      </div>
              ...
              >
                <button
                  ...
                  style={{
                    ...
                    border: "none",
                    background: isKeep ? CP_ACCENT : "var(--cp-bg-card)",
                  ...
                  onMouseLeave={(e) =>
                    !isKeep && (e.currentTarget.style.background = "var(--cp-bg-card)")
                  }
                >
                  ✓ Keep
                </button>
                  ...
                  dupe.matchedSource !== dupe.incoming.hint && (
                    <button
                      ...
                      style={{
                        ...
                        borderRadius: 0,
                        border: "none",
                        background: isMerge ? CLR_EMERALD : "var(--cp-bg-card)",
                      ...
                      onMouseEnter={(e) =>
                        !isMerge && (e.currentTarget.style.background = "rgba(5,150,105,0.10)")
                      }
                      onMouseLeave={(e) =>
                        !isMerge && (e.currentTarget.style.background = "var(--cp-bg-card)")
                      }
                    >
                      ↻ Merge
                    </button>
                ...
                <button
                  ...
                  style={{
                    ...
                    border: "none",
                    background: isSkip ? CLR_GRAY : "var(--cp-bg-card)",
                  ...
                  onMouseEnter={(e) =>
                    !isSkip && (e.currentTarget.style.background = "rgba(155,154,151,0.1)")
                  }
                  onMouseLeave={(e) =>
                    !isSkip && (e.currentTarget.style.background = "var(--cp-bg-card)")
                  }
                >
                  ✕ Skip
                </button>
