...
import { FileText, BookOpen, Hash, Star, Tag, ChartColumn, CircleAlert, X } from "lucide-react";
        ...
        {kpis.map((k) => {
          ...
          return (
            ...
            >
              ...
              >
                <AnimatedNumber value={k.value} duration={400} />
              </div>
            </div>
          );
        })}
    ...
    <div style={styles.statsPanel}>
      ...
      >
        <ChartColumn
          ...
          style={{ marginBottom: 12, strokeWidth: 1.5 }}
        />
        <div
          style={{
            fontWeight: 500,
...
const PanelHeader = ({ onClose }) => (
  ...
  >
    ...
    <button
      ...
      onMouseEnter={(e) => {
        e.currentTarget.style.background = "var(--cp-bg-tab)";
