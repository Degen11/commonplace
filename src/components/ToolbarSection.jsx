    ...
    <>
      <div ref={toolbarRef} style={styles.toolbar}>
        ...
        <div ref={sortRef} style={{ position: "relative" }}>
          <button style={{ ...styles.sortBtn, ...(sortBy !== "default" ? { borderColor: "#2383E2", color: "#2383E2" } : {}) }} onClick={() => setShowSort(!showSort)}>
      ...
      <div style={{ position: "sticky", top: 0, zIndex: 50, background: "var(--cp-bg)", borderBottom: "1px solid var(--cp-border)" }}>
        <div className="cat-scroll" ref={catScrollRef} onScroll={updateCatFade}
          ...
          {favCount > 0 && (
            <button onClick={() => setFavFilter(!favFilter)} style={{ ...styles.catPill, ...(favFilter ? { background: "#FEF3C7", color: "#D97706", borderColor: "#FDE68A" } : {}) }}>
