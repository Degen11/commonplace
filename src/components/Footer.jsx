...
// ── Footer ──
// Privacy and Terms are real pages (public/privacy.html, public/terms.html)
// rather than in-app modals — they need their own URL to be linkable from an
// app-store listing or a DPA request, and to be crawlable/archivable. Keep
// their content in sync with those two files if either changes.
  ...
  return (
    <footer style={styles.footer}>
      ...
      <div style={{ display: "flex", gap: 14, justifyContent: "center", alignItems: "center", marginTop: 10 }}>
        ...
        <a
          href="/privacy"
          style={{ display: "inline-flex", alignItems: "center", minHeight: 44, color: "var(--cp-text-muted)", fontSize: 12, textDecoration: "none" }}
        >
          Privacy
        </a>
        <a
