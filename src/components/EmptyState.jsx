  ...
  return (
    ...
    >
      ...
      <rect
        ...
        rx="4"
        fill="var(--cp-bg-tab)"
        stroke="var(--cp-border-dim)"
        strokeWidth="1.5"
      />
      {/* Folder tab */}
      <path
        d="M10 28V20a4 4 0 0 1 4-4h14l4 8H10z"
        fill="var(--cp-bg-tab)"
        stroke="var(--cp-border-dim)"
        strokeWidth="1.5"
      />
            ...
            {catFilter !== "All" && (
              <button
                ...
                style={{
                  ...
                  background: "var(--cp-bg-card)",
                  fontSize: 12,
                  color: getCatColor(catFilter, customCats).text,
                  cursor: "pointer",
                  fontFamily: "inherit",
                  fontWeight: 500,
                }}
              ...
              >
                {catFilter} <X size={10} strokeWidth={2} />
              </button>
            )}
            {search && (
              <button
                ...
                onClick={() => setSearch("")}
              >
                "{search}" <X size={10} strokeWidth={2} />
              </button>
            )}
            {favFilter && (
              <button
                ...
                style={{
                  ...
                  padding: "4px 10px",
                  borderRadius: 50,
                  border: "1px solid var(--cp-fav-chip-border)",
                  background: "var(--cp-fav-chip-bg)",
                  fontSize: 12,
                  color: "var(--cp-fav-chip-text)",
                  cursor: "pointer",
                  fontFamily: "inherit",
                  fontWeight: 500,
                }}
              ...
              >
                &star; Favorites <X size={10} strokeWidth={2} />
              </button>
            )}
          </div>
          <div
