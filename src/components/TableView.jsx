...
const COL_CONFIG = {
  content:  { label: "Content",  style: { flex: 1, minWidth: 200, paddingRight: 32, textAlign: "left" } },
  source:   { label: "Source",   style: { width: 200, paddingRight: 32, textAlign: "left" } },
  category: { label: "Category", style: { width: 90, paddingRight: 16, textAlign: "left" } },
};
