...
export const styles = {
  ...
  restoreBanner: {
    ...
    border: "1px solid rgba(60,87,117,0.14)",
    borderRadius: 6,
    marginBottom: 20,
    fontSize: 13,
    color: CP_ACCENT_TEXT,
  ...
  restoreDismiss: {
    padding: "5px 10px",
    borderRadius: 6,
    border: "1px solid rgba(60,87,117,0.25)",
    background: "transparent",
    color: CP_ACCENT,
    fontSize: 12,
    cursor: "pointer",
  ...
  bulkBar: {
    ...
    background: "var(--cp-bulk-bg)",
    backdropFilter: "blur(16px)",
    WebkitBackdropFilter: "blur(16px)",
    border: "1px solid var(--cp-bulk-border)",
    borderRadius: 6,
  ...
  bulkN: {
    fontSize: 12,
    fontWeight: 600,
    color: "var(--cp-bulk-badge-text)",
    whiteSpace: "nowrap",
    background: "var(--cp-bulk-badge)",
    padding: "5px 12px",
    borderRadius: 4,
    lineHeight: 1,
    letterSpacing: 0.2,
  ...
  bulkDivider: {
    width: 1,
    height: 20,
    background: "var(--cp-bulk-divider)",
    margin: "0 10px",
    flexShrink: 0,
  },
  ...
  row: {
    ...
    padding: "10px 0",
    borderBottom: "1px solid var(--cp-border)",
    transition: "background .1s ease, opacity .15s",
    minHeight: 48,
    background: "var(--cp-bg-card)",
  },
  rowCompact: {
  ...
  check: {
    ...
    height: 16,
    borderRadius: 4,
    border: "1.5px solid var(--cp-border-dim)",
    borderColor: "var(--cp-border-dim)",
    cursor: "pointer",
    display: "flex",
    alignItems: "center",
    justifyContent: "center",
  ...
  footer: {
    ...
    fontSize: 12,
    color: "var(--cp-text-faint)",
    borderTop: "1px solid var(--cp-border-light)",
    marginTop: 40,
  },
