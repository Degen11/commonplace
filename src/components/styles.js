...
export const styles = {
  ...
  hoverActions:{position:"absolute",right:0,top:0,bottom:0,display:"flex",alignItems:"center",gap:2,paddingRight:8,paddingLeft:24,opacity:0,transition:"opacity .12s ease",pointerEvents:"none",background:"linear-gradient(to right, transparent, var(--cp-bg-card) 20px)"},
  hoverActionsCompact:{position:"absolute",right:0,top:0,bottom:0,display:"flex",alignItems:"center",gap:1,paddingRight:6,paddingLeft:20,opacity:0,transition:"opacity .12s ease",pointerEvents:"none",background:"linear-gradient(to right, transparent, var(--cp-bg-card) 16px)"},
