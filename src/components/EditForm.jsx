    ...
    >
      <textarea
        ...
        onKeyDown={(e) => {
          ...
          if (e.key === "Enter" && (e.metaKey || e.ctrlKey)) {
            e.preventDefault();
            onSave(q.id, text, source, category);
          }
        }}
        autoFocus
      />
      ...
      <div style={{ display: "flex", gap: 6, alignItems: "center", flexWrap: "wrap" }}>
        ...
        <select
          style={{
            ...styles.editSel,
            ...(isMobile ? { fontSize: 14, padding: "8px 26px 8px 10px" } : {}),
          }}
          value={category}
        ...
        <button
          ...
          style={{
            ...styles.editSave,
            ...(isMobile ? { padding: "8px 16px", fontSize: 14, minHeight: 40 } : {}),
          }}
          onClick={() => onSave(q.id, text, source, category)}
        >
          Save
        </button>
        <button
          ...
          style={{
            ...styles.editCancel,
            ...(isMobile ? { padding: "8px 12px", fontSize: 14, minHeight: 40 } : {}),
          }}
          onClick={onCancel}
        >
          Cancel
